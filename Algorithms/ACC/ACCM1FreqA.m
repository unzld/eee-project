...
count = 0;
for i = 1:1:7 
    filename = sprintf('2AF_FreqA_Dataset%d_ben.csv',i);
...
count = 0;
for i = 1:1:7 
    filename = sprintf('2AF_FreqA_Dataset%d_mal.csv',i);
    %resultMcut = resultM(:,1+count:770+count);   % for running both freqs
        resultMcut = resultM(:,1+count:385+count);     % for running one freq
    resultMcut = [resultMcut sum(resultMcut,2)];
    csvwrite(filename, resultMcut);
...
count = 0;
for i = 1:1:7 
    filename = sprintf('2.5AF_FreqA_Dataset%d_ben.csv',i);
    %resultMcut = resultM(:,1+count:770+count);   % for running both freqs
        resultMcut = resultM(:,1+count:385+count);     % for running one freq
    resultMcut = [resultMcut sum(resultMcut,2)];
    csvwrite(filename, resultMcut);
...
count = 0;
for i = 1:1:7 
    filename = sprintf('2.5AF_FreqA_Dataset%d_mal.csv',i);
    %resultMcut = resultM(:,1+count:770+count);   % for running both freqs
        resultMcut = resultM(:,1+count:385+count);     % for running one freq
    resultMcut = [resultMcut sum(resultMcut,2)];
    csvwrite(filename, resultMcut);
...
count = 0;
for i = 1:1:7 
    filename = sprintf('1.67AF_FreqA_Dataset%d_ben.csv',i);
    %resultMcut = resultM(:,1+count:770+count);   % for running both freqs
        resultMcut = resultM(:,1+count:385+count);     % for running one freq
    resultMcut = [resultMcut sum(resultMcut,2)];
    csvwrite(filename, resultMcut);
...
count = 0;
for i = 1:1:7 
    filename = sprintf('1.67AF_FreqA_Dataset%d_mal.csv',i);
    %resultMcut = resultM(:,1+count:770+count);   % for running both freqs
        resultMcut = resultM(:,1+count:385+count);     % for running one freq
    resultMcut = [resultMcut sum(resultMcut,2)];
    csvwrite(filename, resultMcut);
...
count = 0;
for i = 1:1:7 
    filename = sprintf('1.43AF_FreqA_Dataset%d_ben.csv',i);
    %resultMcut = resultM(:,1+count:770+count);   % for running both freqs
        resultMcut = resultM(:,1+count:385+count);     % for running one freq
    resultMcut = [resultMcut sum(resultMcut,2)];
    csvwrite(filename, resultMcut);
...
count = 0;
for i = 1:1:7 
    filename = sprintf('1.43AF_FreqA_Dataset%d_mal.csv',i);
    %resultMcut = resultM(:,1+count:770+count);   % for running both freqs
        resultMcut = resultM(:,1+count:385+count);     % for running one freq
    resultMcut = [resultMcut sum(resultMcut,2)];
    csvwrite(filename, resultMcut);
...
count = 0;
for i = 1:1:7 
    filename = sprintf('1.25AF_FreqA_Dataset%d_ben.csv',i);
    %resultMcut = resultM(:,1+count:770+count);   % for running both freqs
        resultMcut = resultM(:,1+count:385+count);     % for running one freq
    resultMcut = [resultMcut sum(resultMcut,2)];
    csvwrite(filename, resultMcut);
...
count = 0;
for i = 1:1:7 
    filename = sprintf('1.25AF_FreqA_Dataset%d_mal.csv',i);
    %resultMcut = resultM(:,1+count:770+count);   % for running both freqs
        resultMcut = resultM(:,1+count:385+count);     % for running one freq
    resultMcut = [resultMcut sum(resultMcut,2)];
    csvwrite(filename, resultMcut);
...
count = 0;
for i = 1:1:7 
    filename = sprintf('1.11AF_FreqA_Dataset%d_ben.csv',i);
    %resultMcut = resultM(:,1+count:770+count);   % for running both freqs
        resultMcut = resultM(:,1+count:385+count);     % for running one freq
    resultMcut = [resultMcut sum(resultMcut,2)];
    csvwrite(filename, resultMcut);
...
count = 0;
for i = 1:1:7 
    filename = sprintf('1.11AF_FreqA_Dataset%d_mal.csv',i);
    %resultMcut = resultM(:,1+count:770+count);   % for running both freqs
        resultMcut = resultM(:,1+count:385+count);     % for running one freq
    resultMcut = [resultMcut sum(resultMcut,2)];
    csvwrite(filename, resultMcut);
